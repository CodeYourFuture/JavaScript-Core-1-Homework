...
function journeyPlanner(locationArray, transportMode) {
  let location = locationArray.filter((element) =>
    element.includes(transportMode)
  );
  return location.map((item) => item[0]);
}
