...
{
  var array=getAllFrequencies();
  var freq_array = new Array();
  var j=0 // index for the freq_array
  for(let i=0 ; i < array.length ; i++ )
  {
    if (  isRadioStation(array[i])  )
    {
      freq_array[j]=array[i];
      j++;
    }
  }
  return freq_array;
