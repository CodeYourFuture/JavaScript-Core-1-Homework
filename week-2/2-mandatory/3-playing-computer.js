/*
  ...
  6. What value does the "a" parameter take in the first "f1" call? i = 1
  7. What is the value of the "a" outer variable when "f1" is called for the first time? a = 6 + 1 = 7
*/
