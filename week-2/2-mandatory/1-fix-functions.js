...
function mood() {
	...
	if (isHappy) {
		console.log(' hppy is called');
		return 'I am happy';
	} else {
		console.log(' not haapy is called');
...
test('sortArray function works', arraysEqual(sortArray(), [ 'a', 'c', 'e', 'f', 'n', 'z' ]));
...
test('get3rdIndex function works - case 2', get3rdIndex([ 11, 37, 62, 18, 19, 3, 30 ]) === 18);
