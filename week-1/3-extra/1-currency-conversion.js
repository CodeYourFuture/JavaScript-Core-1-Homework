...
function convertToUSD(priceToConvert) {
	return priceToConvert * 1.4;
}
...
function convertToBRL(priceConver) {
	let convertedPrice = priceConver * 5.7;
	return convertedPrice + convertedPrice * 0.01;
}
