...
/*  
  .toFixed(6) method converts the number to a string with 6 decimal precision 
  and the Number() function converts it back to the number. 
  This is to avoid the floating-point accuracy errors 
*/
...
/* BETTER PRACTICE */
var number = add(startingValue, 10);
number = multiply(number, 2);
let goodCode = format(number);
