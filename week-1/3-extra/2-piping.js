...
// this is hard to read/understand what's going on
let badCode = format(multiply(add(startingValue, 10), 2));

/* BETTER PRACTICE */
const addTen = add(startingValue, 10);
const multiplyByTwo = multiply(addTen, 2);
const formattedResult = format(multiplyByTwo);

let goodCode = formattedResult;
